...
# ? - 0-1 matches
# {n} - n matches
# $ - if string ends with this pattern
# . - [^\n]
...
res = pattern_3.findall('theres a lot of msg msg1 msg2 msg3')
print(res)
res = pattern_3.finditer('theres a lot of msg msg1 msg2 msg3')
for i in res:
    print(i.span())
    print(i.group())
    print(i.start())
...
result = pattern.split('theres a lot of msg, msg1, msg2, msg3')
print(result)
result = pattern.split('theres a lot of msg, msg1, msg2, msg3', 2)
print(result)
result = pattern.split('theres a lot of msg, msg1, msg2, msg3', 3)
print(result)
...
print(res)
res = re.finditer('[0-9+]', 'string to find numbers 1 1')
for i in res:
    print(i.span())
    print(i.group())
...
print(res)
res = re.search('.*[0-9]?', 'abc 1')
print(res)
demo_str = 'https://site.com'
pattern = "https://.*\.com"
result = re.search(pattern, 'https://dasdasd.asda.rge.a.comsads')
print(result)
result = re.findall(pattern, 'https://dasdasd.asda.rge.a.comsads, qwwqeqwe, https://site.com')
print(result)

demo_str = 'date1 = 12.05.2023 date2 = 13.05.2023'
pattern = '\d{2}[-./]\d{2}[-./]\d{4}'
result = re.findall(pattern, demo_str)
print(result)
